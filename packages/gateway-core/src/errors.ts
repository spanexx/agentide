 ...
 * - ERROR_CODES: 16 stable GATEWAY_* string identifiers (single source of truth)
...
// CID:errors-001 - ERROR_CODES
// Purpose: 16 stable string identifiers used across every Gateway failure path; consumers (MCP adapters, dashboards, CI scripts) match on these codes
